...
var cardIndexC = cardIndex{gameobjects.CA, gameobjects.CK, gameobjects.CQ, gameobjects.CJ, gameobjects.CT, gameobjects.C9, gameobjects.C8, gameobjects.C7, gameobjects.C6, gameobjects.C5, gameobjects.C4, gameobjects.C3, gameobjects.C2}
var cardIndexH = cardIndex{gameobjects.HA, gameobjects.HK, gameobjects.HQ, gameobjects.HJ, gameobjects.HT, gameobjects.H9, gameobjects.H8, gameobjects.H7, gameobjects.H6, gameobjects.H5, gameobjects.H4, gameobjects.H3, gameobjects.H2}
var cardIndexD = cardIndex{gameobjects.DA, gameobjects.DK, gameobjects.DQ, gameobjects.DJ, gameobjects.DT, gameobjects.D9, gameobjects.D8, gameobjects.D7, gameobjects.D6, gameobjects.D5, gameobjects.D4, gameobjects.D3, gameobjects.D2}

var cardIndexFull = cardIndex{
	gameobjects.SA, gameobjects.HA, gameobjects.CA, gameobjects.DA,
	gameobjects.SK, gameobjects.HK, gameobjects.CK, gameobjects.DK,
	gameobjects.SQ, gameobjects.HQ, gameobjects.CQ, gameobjects.DQ,
	gameobjects.SJ, gameobjects.HJ, gameobjects.CJ, gameobjects.DJ,
	gameobjects.ST, gameobjects.HT, gameobjects.CT, gameobjects.DT,
	gameobjects.S9, gameobjects.H9, gameobjects.C9, gameobjects.D9,
	gameobjects.S8, gameobjects.H8, gameobjects.C8, gameobjects.D8,
	gameobjects.S7, gameobjects.H7, gameobjects.C7, gameobjects.D7,
	gameobjects.S6, gameobjects.H6, gameobjects.C6, gameobjects.D6,
	gameobjects.S5, gameobjects.H5, gameobjects.C5, gameobjects.D5,
	gameobjects.S4, gameobjects.H4, gameobjects.C4, gameobjects.D4,
...
type equivalentFiveCardHand struct {
	...
	c1r   gameobjects.CardRank // card 1 rank
	c2r   gameobjects.CardRank // card 2 rank
	c3r   gameobjects.CardRank
	c4r   gameobjects.CardRank
	c5r   gameobjects.CardRank
...
type rankCounter struct {
	...
	top4x1      gameobjects.CardRank // rank of the top quads

	top3x1 gameobjects.CardRank // rank of the top trips / three of a kind
	top3x2 gameobjects.CardRank // rank of the 2nd trips / three of a kind

	top2x1 gameobjects.CardRank // rank of the top pair
	top2x2 gameobjects.CardRank // rank of the second pair ...
	top2x3 gameobjects.CardRank

	top1x1 gameobjects.CardRank
	top1x2 gameobjects.CardRank
	top1x3 gameobjects.CardRank
	top1x4 gameobjects.CardRank
	top1x5 gameobjects.CardRank
...
// type sfIndexByFirstgameobjects.CardRank []int
...
func prepareHandAnalysisTools() error {
	...
	crm = gameobjects.CreateCardRankMap()
...
func getCardStringByIndex(i int) (card gameobjects.CardString, err error) {
	// Info.Printf("%s\n\n", ThisFunc())
...
func genSCLfromSSI(ssiPtr *[][]int, dPtr *cardDeck) (sfclPtr *[]fiveCardList, err error) {
	...
	for comboNum := range ssi {
		...
		var cl = fiveCardList{gameobjects.NoCardPtr, gameobjects.NoCardPtr, gameobjects.NoCardPtr, gameobjects.NoCardPtr, gameobjects.NoCardPtr}
		sfcl[comboNum] = cl
...
func countRanksInfiveCardList(clPtr *fiveCardList) (rcPtr *rankCounter) {
	...
	rc.top1x1 = gameobjects.RX // give it initial "unset" value
	rc.top1x2 = gameobjects.RX
	rc.top1x3 = gameobjects.RX
	rc.top1x4 = gameobjects.RX
	rc.top1x5 = gameobjects.RX
	rc.top2x1 = gameobjects.RX
	rc.top2x2 = gameobjects.RX
	rc.top2x3 = gameobjects.RX
	rc.top3x1 = gameobjects.RX
	rc.top3x2 = gameobjects.RX
	rc.top4x1 = gameobjects.RX
...
func find5OrMoreOfSameSuitInfiveCardList(fclPtr *fiveCardList, cll int, scPtr *suitCounter) (resultingFclPtr *fiveCardList, topSuit gameobjects.CardSuit, err error) {
	// Info.Printf("%s\n\n", ThisFunc())
	...
	if scPtr.max < 5 || cll < 5 {
		...
		return resultingFclPtr, gameobjects.X, err
	}

	// Figure out which suit is most common in the list.
	topSuit = gameobjects.X
	for _, cs := range gameobjects.SuitList {
...
func orderCardsOfSameSuit(clPtr *fiveCardList, cs gameobjects.CardSuit) (gameobjects.CardRank, gameobjects.CardRank, gameobjects.CardRank, gameobjects.CardRank, gameobjects.CardRank) {
	// Info.Printf("%s\n\n", ThisFunc())

	cl := *clPtr

	var c gameobjects.Card

	var myFlCard1, myFlCard2, myFlCard3, myFlCard4, myFlCard5, myFlCard6, myFlCard7 gameobjects.Card
	myFlCard1 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myFlCard2 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myFlCard3 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myFlCard4 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myFlCard5 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myFlCard6 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myFlCard7 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	...
	for _, cPtr := range cl {
		...
		if c.Suit == cs { // if we found a card of requested suit...
			...
			if myFlCard1.Rank == gameobjects.RX { // 1st card in the suit of the Fl
				myFlCard1 = *cPtr

			} else if myFlCard2.Rank == gameobjects.RX { // 2nd card in the suit of the Fl
			...
			} else if myFlCard3.Rank == gameobjects.RX { // 3rd card in the suit of the Fl
			...
			} else if myFlCard4.Rank == gameobjects.RX {
			...
			} else if myFlCard5.Rank == gameobjects.RX {
			...
			} else if myFlCard6.Rank == gameobjects.RX {
			...
			} else if myFlCard7.Rank == gameobjects.RX {
...
// A as the last gameobjects.Card, not first.
func orderCardsOfSameSuit2(clPtr *fiveCardList, cs gameobjects.CardSuit) (resultingClPtr *fiveCardList, err error) {
	// Info.Printf("%s\n\n", ThisFunc())
	...
	for _, cPtr := range cl {
		...
		if cPtr != nil {
			c = *cPtr
			// fmt.Println("in orderCardsOfSameSuit2, gameobjects.Card from range: ", c)
	...
	// switch {
	// case myFlCard6.Rank != gameobjects.RX:
	// 	resultingClPtr[5] = myFlCard6Ptr
	// case myFlCard7.Rank != gameobjects.RX:
...
func orderCardsOfMixedSuit(clPtr *fiveCardList) (resultingClPtr *fiveCardList, err error) {
	...
	// var myCard1, myCard2, myCard3, myCard4, myCard5, myCard6, myCard7 gameobjects.Card
	var myCard1, myCard2, myCard3, myCard4, myCard5 gameobjects.Card
	myCard1 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myCard2 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myCard3 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myCard4 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	myCard5 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	// myCard6 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	// myCard7 = gameobjects.Card{gameobjects.RX, gameobjects.X, false, false, false, false, 0}
	...
	for _, cPtr := range cl {
		...
		if cPtr != nil {
			c = *cPtr
			// fmt.Println("in orderCardsOfMixedSuit, gameobjects.Card from range: ", c)

			if myCard1.Rank == gameobjects.RX { // 1st card in the suit of the Fl
				myCard1 = *cPtr

			} else if myCard2.Rank == gameobjects.RX { // 2nd card in the suit of the Fl
			...
			} else if myCard3.Rank == gameobjects.RX { // 3rd card in the suit of the Fl
			...
			} else if myCard4.Rank == gameobjects.RX {
			...
			} else if myCard5.Rank == gameobjects.RX {
				...
				/*
					} else if myCard6.Rank == gameobjects.RX {
					...
					} else if myCard7.Rank == gameobjects.RX {
	...
	// switch {
	// case myCard6.Rank != gameobjects.RX:
	// 	resultingClPtr[5] = myCard6Ptr
	// case myCard7.Rank != gameobjects.RX:
...
func checkForFH_5c(fclPtr *fiveCardList, cll int, rcPtr *rankCounter, scPtr *suitCounter, handNamePtr *string) (err error) {
	...
	*handNamePtr = "did not find a FH"
	...
	if rcPtr.max == 3 {
		...
		} // Since gameobjects.RankList is arranged from highest to lowest rank, the top3x1 and top3x2, ..., are properly set.
		...
		*/
		...
		if rcPtr.top2x1 != gameobjects.RX {
			*handNamePtr = "FH, " + string(rcPtr.top3x1) + "s full of " + string(rcPtr.top2x1) + "s."
			// case 3x, 2x
			// fmt.Println("Found FH ############## A")
...
func checkForFl_5c(fclPtr *fiveCardList, cll int, rcPtr *rankCounter, scPtr *suitCounter, handNamePtr *string) (err error) {
	...
	var mySuit gameobjects.CardSuit

	var cr1, cr2, cr3, cr4, cr5 gameobjects.CardRank
	cr1 = gameobjects.RX
	cr2 = gameobjects.RX
	cr3 = gameobjects.RX
	cr4 = gameobjects.RX
	...
	switch {
	case scPtr.scm[gameobjects.S] >= 5:
		mySuit = gameobjects.S
	case scPtr.scm[gameobjects.C] >= 5:
		mySuit = gameobjects.C
	case scPtr.scm[gameobjects.H] >= 5:
		mySuit = gameobjects.H
	case scPtr.scm[gameobjects.D] >= 5:
		mySuit = gameobjects.D
	default:
...
L02:
	for i := 0; i <= 9; i++ {
		// fmt.Println("i: ", i)
		// fmt.Printf("in checkForSt_5c gameobjects.RankListFull of i is: %v\n\n", gameobjects.RankListFull[i])
		// fmt.Printf("clPtr 0 : %v; 1: %v; 2: %v; 3: %v; 4: %v; 5: %v; 6: %v\n", clPtr[0].Rank, clPtr[1], clPtr[2], clPtr[3], clPtr[4], clPtr[5], clPtr[6])
		// fmt.Printf("rankLFi : %v;+1: %v;+2: %v;+3: %v;+4: %v\n\n", gameobjects.RankListFull[i], gameobjects.RankListFull[i+1], gameobjects.RankListFull[i+2], gameobjects.RankListFull[i+3], gameobjects.RankListFull[i+4])

		// if (clPtr[0].Rank == gameobjects.RankListFull[i] || clPtr[1].Rank == gameobjects.RankListFull[i] || clPtr[2].Rank == gameobjects.RankListFull[i] || clPtr[3].Rank == gameobjects.RankListFull[i] || clPtr[4].Rank == gameobjects.RankListFull[i] || clPtr[5].Rank == gameobjects.RankListFull[i] || clPtr[6].Rank == gameobjects.RankListFull[i]) &&
		// 	(clPtr[0].Rank == gameobjects.RankListFull[i+1] || clPtr[1].Rank == gameobjects.RankListFull[i+1] || clPtr[2].Rank == gameobjects.RankListFull[i+1] || clPtr[3].Rank == gameobjects.RankListFull[i+1] || clPtr[4].Rank == gameobjects.RankListFull[i+1] || clPtr[5].Rank == gameobjects.RankListFull[i+1] || clPtr[6].Rank == gameobjects.RankListFull[i+1]) &&
		// 	(clPtr[0].Rank == gameobjects.RankListFull[i+2] || clPtr[1].Rank == gameobjects.RankListFull[i+2] || clPtr[2].Rank == gameobjects.RankListFull[i+2] || clPtr[3].Rank == gameobjects.RankListFull[i+2] || clPtr[4].Rank == gameobjects.RankListFull[i+2] || clPtr[5].Rank == gameobjects.RankListFull[i+2] || clPtr[6].Rank == gameobjects.RankListFull[i+2]) &&
		// 	(clPtr[0].Rank == gameobjects.RankListFull[i+3] || clPtr[1].Rank == gameobjects.RankListFull[i+3] || clPtr[2].Rank == gameobjects.RankListFull[i+3] || clPtr[3].Rank == gameobjects.RankListFull[i+3] || clPtr[4].Rank == gameobjects.RankListFull[i+3] || clPtr[5].Rank == gameobjects.RankListFull[i+3] || clPtr[6].Rank == gameobjects.RankListFull[i+3]) &&
		// 	(clPtr[0].Rank == gameobjects.RankListFull[i+4] || clPtr[1].Rank == gameobjects.RankListFull[i+4] || clPtr[2].Rank == gameobjects.RankListFull[i+4] || clPtr[3].Rank == gameobjects.RankListFull[i+4] || clPtr[4].Rank == gameobjects.RankListFull[i+4] || clPtr[5].Rank == gameobjects.RankListFull[i+4] || clPtr[6].Rank == gameobjects.RankListFull[i+4]) {

		if (cl[0].Rank == gameobjects.RankListFull[i] || cl[1].Rank == gameobjects.RankListFull[i] || cl[2].Rank == gameobjects.RankListFull[i] || cl[3].Rank == gameobjects.RankListFull[i] || cl[4].Rank == gameobjects.RankListFull[i]) &&
			(cl[0].Rank == gameobjects.RankListFull[i+1] || cl[1].Rank == gameobjects.RankListFull[i+1] || cl[2].Rank == gameobjects.RankListFull[i+1] || cl[3].Rank == gameobjects.RankListFull[i+1] || cl[4].Rank == gameobjects.RankListFull[i+1]) &&
			(cl[0].Rank == gameobjects.RankListFull[i+2] || cl[1].Rank == gameobjects.RankListFull[i+2] || cl[2].Rank == gameobjects.RankListFull[i+2] || cl[3].Rank == gameobjects.RankListFull[i+2] || cl[4].Rank == gameobjects.RankListFull[i+2]) &&
			(cl[0].Rank == gameobjects.RankListFull[i+3] || cl[1].Rank == gameobjects.RankListFull[i+3] || cl[2].Rank == gameobjects.RankListFull[i+3] || cl[3].Rank == gameobjects.RankListFull[i+3] || cl[4].Rank == gameobjects.RankListFull[i+3]) &&
			(cl[0].Rank == gameobjects.RankListFull[i+4] || cl[1].Rank == gameobjects.RankListFull[i+4] || cl[2].Rank == gameobjects.RankListFull[i+4] || cl[3].Rank == gameobjects.RankListFull[i+4] || cl[4].Rank == gameobjects.RankListFull[i+4]) {

			// fmt.Printf("in checkForSt_5c inside IF\n%v %v %v %v %v\n", gameobjects.RankListFull[i], gameobjects.RankListFull[i+1], gameobjects.RankListFull[i+2], gameobjects.RankListFull[i+3], gameobjects.RankListFull[i+4])

			*handNamePtr = string(gameobjects.RankListFull[i]) + " high Straight"
...
func checkFor2x2_5c(clPtr *fiveCardList, cll int, rcPtr *rankCounter, handNamePtr *string) (err error) {
	...
	// if err04 == nil && rcPtr.top2x2 != gameobjects.RX {
	if pair_count == 2 {
...
func findPairs(clPtr *fiveCardList, cll int, rcPtr *rankCounter) (err error) {
	...
	for i := 0; i < cll-2; i++ {
		...
		if cl[i].Rank == cl[i+1].Rank {
			...
			} else if rcPtr.top2x2 == gameobjects.RX {
			...
			switch {
			case rcPtr.top1x1 == gameobjects.RX:
				rcPtr.top1x1 = cl[i].Rank
			case rcPtr.top1x2 == gameobjects.RX:
				rcPtr.top1x2 = cl[i].Rank
			case rcPtr.top1x3 == gameobjects.RX:
				rcPtr.top1x3 = cl[i].Rank
			case rcPtr.top1x4 == gameobjects.RX:
				rcPtr.top1x4 = cl[i].Rank
			case rcPtr.top1x5 == gameobjects.RX:
...
// #####################################################################
func getRankOfNthCardForGivenIndexOfscl(i int, n int) gameobjects.CardRank {
...
func orderSFIndexesAsc(siPtr *[]int) (err error) {
	...
	sort.SliceStable(si, func(i, j int) bool {
		...
		if sOfAllFCLs[si[i]][0].Rank == gameobjects.RA && sOfAllFCLs[si[i]][1].Rank == gameobjects.R5 {
			iltj = true
		} else if sOfAllFCLs[si[j]][0].Rank == gameobjects.RA && sOfAllFCLs[si[j]][1].Rank == gameobjects.R5 {
			iltj = false
